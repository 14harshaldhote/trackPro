...
urlpatterns = [
    # =========================================================================
    # MAIN APP ROUTES - Traditional Django multi-page app
    # =========================================================================
    
    # Main views (serve complete pages with base template)
    path('', views_spa.panel_dashboard, name='dashboard'),
    path('today/', views_spa.panel_today, name='today_view'),
    path('trackers/', views_spa.panel_trackers_list, name='tracker_list'),
    path('tracker/<str:tracker_id>/', views_spa.panel_tracker_detail, name='tracker_detail'),
    path('week/', views_spa.panel_week, name='week_view'),
    path('month/', views_spa.panel_month, name='month_view'),
    path('analytics/', views_spa.panel_analytics, name='analytics_dashboard'),
    path('goals/', views_spa.panel_goals, name='goals'),
    path('insights/', views_spa.panel_insights, name='insights'),
    path('help/', views_spa.panel_help, name='help_center'),
    path('templates/', views_spa.panel_templates, name='templates'),
    path('settings/', views_spa.panel_settings, name='settings'),
    path('settings/<str:section>/', views_spa.panel_settings, name='settings_section'),
    
    # Modals (AJAX-loaded content)
    ...
    path('api/tracker/<str:tracker_id>/restore/', views_api.api_tracker_restore, name='api_tracker_restore'),
